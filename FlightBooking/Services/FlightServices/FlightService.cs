...
namespace FlightBooking.Services.FlightServices
{
    public class FlightService : IFlightService
    {
        ...
        public FlightService(IMapper mapper, IDatabaseSettings _databaseSettings, IMongoCollection<Booking> bookingCollection)
        {
...
//Mongodb'de Create ve Update işlemlerinde önce Map'leme yapılır sonra işlem yapılır
// Listeleme ve Id'ye göe getirme işlemlerinde önce işlem yapılır sonra Map'leme yapılır