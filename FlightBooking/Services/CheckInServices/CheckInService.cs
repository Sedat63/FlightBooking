...
{
    using FlightBooking.Entities; // Entity namspaceleriniz
    using MongoDB.Driver;
    ...
    public class CheckInService : ICheckInService
    {
        ...
        // Sadece ihtiyacımız olan koleksiyonları dışarıdan enjekte alıyoruz. 
        // Artık içeride "new MongoClient" yapmamıza gerek kalmadı!
        public CheckInService(
            IMongoCollection<Booking> bookingCollection,
            IMongoCollection<CheckIn> checkInCollection)
        {
        ...
        public async Task CompleteCheckInAsync(CompleteCheckInDto dto)
        {
            ...
            // Bu metot çalıştığı an MongoDB'de "CheckIns" isminde yeni koleksiyonunuz başarıyla belirecektir!
